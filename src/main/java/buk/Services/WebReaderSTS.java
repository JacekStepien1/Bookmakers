...
//		File fileUrl = new File("F:\\Java\\Eclipse2020\\buk2-building\\src\\main\\resources\\sts-turcja.htm");
	...
	String polandEkstraklasaUrl = "https://www.sts.pl/pl/zaklady-bukmacherskie/pilka-nozna/polska/ekstraklasa/184/30860/86441/";
	
	
	
	File turkey1leagueUrl = new File("src\\main\\resources\\sts-turcja.htm");
	File belarus1leagueUrl = new File("src\\main\\resources\\sts-bialorus.html");
	// File polandEkstraklasaUrl = new File("https://www.sts.pl/pl/zaklady-bukmacherskie/pilka-nozna/polska/ekstraklasa/184/30860/86441/");
	

	public void matchesReader() throws Exception {
		
//		matchesReaderStart(turkey1leagueUrl, turkey1LeagueSTS());
