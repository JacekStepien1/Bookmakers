...
//		matches.add(matchRep.findOne(1L));
//		String leagueName = "choose a league";
...
//	}
	...
	public String index (@PathVariable(name="leauge") String leauge, Model model)  {
		List<Country> countryList = countryRep.findAll();
		//.sort(Comparator.comparing(Country::getId));
		String leagueName = countryRep.league(leauge);
		
		//temporary date, date of reading matches
//		Date date = new Date();
//		SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy.HH:mm");
//		try {
//			date=sdf.parse("02.08.2021.15:00");
